...
/**
 * Given an ACF image array, return the title text of a given image.
 * @param   array  $data    The ACF image array of a singular image.
 * @param   string $attr    The attribute to look for. Defaults to 'alt'.
 * @return  string|null     The attribute value or null.
 */
function getImageAttr($data=null, $attr='alt')
{
    // bail out if we dont have what we need
    if (empty($data)) {
        return null;
