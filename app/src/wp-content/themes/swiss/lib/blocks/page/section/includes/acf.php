...
return array(
  ...
  'sub_fields' => array(
    ...
    array(
			...
			'name' => 'koro_position',
			'type' => 'select',
			'instructions' => 'Adds Koro to the block',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
    ...
    array(
      'key' => 'field_'.$blockName.'_full_height',
      'label' => 'Full height',
      'name' => 'full_height',
      'type' => 'select',
      'instructions' => 'Is the minimum height of the scheme block window full height. This allows us to position blocks nicely.',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => array(
        'width' => '',
