...
An image for Everblox. [See this block in action!](http://swiss.evermade.fi/)
...
* `em everblox add image my-new-block` will clone the `image` block to a new block called `my-new-block`
