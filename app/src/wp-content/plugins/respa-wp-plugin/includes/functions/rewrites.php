<?php namespace Evermade\Respa\Rewrites;

/**
 * Content for single store pages are loaded from the Respa API. We need to create "virtual" pages
 * for that.
 *
...
add_action('init', '\Evermade\Respa\Rewrites\init');
...
add_action('init', '\Evermade\Respa\Rewrites\init_query_vars');
